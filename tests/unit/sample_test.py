from ptbwa_dbx.tasks.sample_etl_task import SampleETLTask
from ptbwa_dbx.tasks.sample_ml_task import SampleMLTask
...
def test_jobs(spark: SparkSession, tmp_path: Path):
    ...
    test_ml_config = {
        "input": common_config,
        "experiment": "/Shared/ptbwa-dbx/sample_experiment"
    }
